...
function caelPanels.gradientPanel (panel)
    ...
    gradientTop:SetGradient("VERTICAL", CreateColor(0, 0, 0, 0), CreateColor(0.84, 0.75, 0.65, 0.5))
    ...
    gradientBottom:SetGradient("VERTICAL", CreateColor(0, 0, 0, 0.75), CreateColor(0, 0, 0, 0))
end
...
caelPanels.eventFrame:SetScript("OnEvent", function(self, event, ...)
    if event == "ADDON_LOADED" then
        ...
        if addon == "caelPanels" then
            ...
            -- Damage Meter
            if C_AddOns.IsAddOnLoaded("alDamageMeter") then
