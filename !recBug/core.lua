...
local function make_backdrop(frame)
    ...
    -- Midnight API compatibility - SetBackdrop removed, use textures instead
    if frame.bg.SetBackdrop then
        ...
        -- Fallback for Midnight API - use solid color texture
        local bg = frame.bg:CreateTexture(nil, "BACKGROUND")
        bg:SetAllPoints()
...
-- Set error handler with Midnight API compatibility
