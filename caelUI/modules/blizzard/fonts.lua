...
do
    ...
    local function set_font (frame, font, size, style, red, green, blue, shadow_red, shadow_green, shadow_blue, shadow_offset_x, shadow_offset_y)
        ...
        frame:SetFont(font, size, style or "")
    ...
    function setup_font(self, _, addon)
        ...
        set_font(NumberFont_Outline_Huge,                fonts.number,        28, "OUTLINE")
        ...
        set_font(SystemFont_OutlineThick_Huge2,          fonts.normal,        20, "OUTLINE")
        set_font(SystemFont_OutlineThick_Huge4,          fonts.bold_italic,   25, "OUTLINE")
        set_font(SystemFont_OutlineThick_WTF,            fonts.bold_italic,   29, "OUTLINE", nil, nil, nil, 0, 0, 0, 1, -1)
        ...
        -- Derived fonts
        set_font(BossEmoteNormalHuge,                    fonts.bold_italic,   25, "OUTLINE")
        ...
        set_font(WorldMapTextFont,                       fonts.bold_italic,   29, "OUTLINE",  nil, nil, nil, 0, 0, 0, 1, -1)
