...
---
local helm = CreateFrame("CheckButton", nil, CharacterModelFrame, "UICheckButtonTemplate")
...
---
local cloak = CreateFrame("CheckButton", nil, CharacterModelFrame, "UICheckButtonTemplate")
